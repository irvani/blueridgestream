...
```mermaid
graph TD
    classDef primary fill:#1e3d59,stroke:#122536,color:#fff;
    classDef secondary fill:#0e7048,stroke:#094a30,color:#fff;
    classDef accent fill:#b25329,stroke:#853e1e,color:#fff;

    A["The Geomorphic Bank<br>(Physical & Ecological)"]:::primary -->|Bioengineering Restores| B["Stable Riffle-Pool Slopes<br>(Lowering Temp below 65°F)"]
    B -->|USACE Savannah District Audit| C["The Regulatory Bank<br>(Institutional & Credit Ledger)"]:::secondary
    C -->|phased credit release schedule| D["Stream Mitigation Credits<br>(RIBITS Ledger Inventory)"]
    D -->|PRM presales to data centers| E["The Wealth & Land Bank<br>(Financial Legacy)"]:::accent
    E -->|30% Joint-Venture split payouts| F["Passive Family Income &<br>Creekside Civil Upgrades"]
```
