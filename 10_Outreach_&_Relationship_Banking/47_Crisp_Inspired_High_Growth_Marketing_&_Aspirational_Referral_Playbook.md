...
```mermaid
graph TD
    A[Referral Sourced] -->|Tier 1: Qualified Lead| B[The Brook Trout Hook<br/>Filson Log Carrier or Orvis Fly Box<br/>$250 Value]
    B -->|Tier 2: Completed Stream Walk| C[The Rainbow Rise<br/>Blue Ridge Reserve Bourbon & Yeti Tundra<br/>$600 Value]
    C -->|Tier 3: Signed Contract| D[The Brown Trout Trophy<br/>2% Split Booster or Private Helicopter Float<br/>$15,000 Value]
    D -->|Tier 4: Annual Drawing| E[The Patagonia Legacy Sweepstakes<br/>7-Day Luxury Argentina Excursion<br/>$30,000 Value]
```
