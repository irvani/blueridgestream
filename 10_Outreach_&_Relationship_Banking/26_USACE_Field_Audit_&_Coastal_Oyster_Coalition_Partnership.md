# File 26: USACE Field Audit & Coastal Oyster Coalition Partnership

> [!IMPORTANT]
> **Strategic Regulatory Hospitality & Statewide Conservation Alignment Plan**:
> - **USACE Interagency Review Team (IRT) Goodwill**: Securing stream mitigation bank approvals from the USACE Savannah District and Georgia EPD requires deep trust and personal verification. By hosting structured, highly educational Field Audit Eco-Tours (complete with guided fly-fishing, drift-boat geomorphic analysis, and whitewater rafting), Hunter Morris can bring federal and state regulators directly to active restoration sites (Goldmine Hollow, Anderson Creek) to demonstrate geomorphic and biological stability first-hand. All interactions will strictly adhere to federal executive branch gift rules.
> - **Statewide Headwaters-to-Coast Conservation Coalition**: Partnering with coastal Georgia oyster shell reclamation groups on Sapelo Island establishes a highly compelling, statewide conservation narrative: 'From High-Gradient Headwaters to Coastal Estuaries.' Stream bioengineering in the Blue Ridge Mountains directly mitigates upstream erosion, preventing millions of tons of heavy clay silt from flowing downstream to choke and smother coastal oyster reefs. Programmatic cross-linking between the web portals provides strong B2B SEO authority and establishes Blue Ridge as the premier watershed steward in Georgia.

## I. USACE & Regulatory Agency Field Audit & Hospitality Plan

### 1. Regulatory Hospitality & Ethics Framework
All educational field audits, meals, and accommodations will strictly adhere to federal executive branch gift regulations outlined in **5 C.F.R. Section 2635.201 (Standards of Ethical Conduct)**. To maintain compliance while building high-trust professional relationships, Blue Ridge operates under the following guidelines:
- **Self-Paid Registration Option**: Offer agency staff a self-paid or institutional per-diem registration fee matching the actual cost of meals and local transport, supported by formal agency travel authorization codes.
- **The 'Modest Food & Refreshments' Rule**: Under 5 C.F.R. Section 2635.203(b)(1), coffee, soft drinks, and modest snacks provided during field briefings do not constitute a prohibited gift.
- **Widely Attended Gathering (WAG) Exception**: Structure evening briefings as open educational symposiums inviting NGO partners, local county extensions, and academic researchers (UGA Warmwater Fisheries Lab) to qualify for agency WAG attendance exemptions.

### 2. The 2-Day 'Headwaters Ecological Tour' Itinerary

#### **Day 1: Goldmine Hollow Geomorphic Showcase & Trout Ecology Briefing**
- **08:30 AM - 10:30 AM**: Field Breakfast & Regulatory Briefing at Goldmine Hollow.
  - *Technical Focus*: Visual and physical audit of the sediment-trapping drop steps on Noontootla Creek. Showcase how the bioengineered log-drop configurations capture upstream fine silts, protecting spawning gravels downstream.
- **10:30 AM - 02:00 PM**: Guided Fly-Fishing & Biological Habitat Inspection.
  - *Activity*: Guided wading and fly-fishing on Noontootla Creek headwaters. Hunter Morris demonstrates the geomorphic pool-riffle sequence, explaining mature Rhododendron maximum shading formulas that keep water temperatures below 65 degrees F for wild Brook and Rainbow trout spawning.
- **02:00 PM - 04:30 PM**: Streamside Soil Geogrid & Geomechanical Demonstration.
  - *Activity*: Physical inspection of the root-wad and geogrid installation. Regulators measure shear strength binding variables under simulated bank-full velocity conditions.
- **06:00 PM - 08:30 PM**: Campfire Educational Symposium & Dinner (Blue Ridge, GA).
  - *Cuisine*: Locally sourced high-mountain wild-caught trout, local mountain venison, and Appalachian vegetables cooked over a live cherrywood campfire. Structured as a UGA academic roundtable on high-gradient geomorphic corrections.

#### **Day 2: Toccoa River Whitewater Drift & Anderson Creek JV Tour**
...
## II. Sapelo Island Coastal Oyster Coalition Partnership
...
- **Statewide Regulatory Support**: The Georgia DNR Coastal Resources Division (CRD) and Environmental Protection Division (EPD) coordinate closely. A unified conservation message builds massive goodwill across both regional regulatory divisions.
...
```html
<!-- Estuary siltation is mitigated at the source through watershed-level headwater stabilization. -->
...
```json
{
  ...
  "@type": "Project",
  "name": "Blue Ridge Mountains-To-Sapelo-Coast Watershed Alliance",
  ...
  "funder": {
    "@type": "Organization",
    "name": "Sapelo Island Oyster Shell Reclamation Coalition"
  }
}
```
