...
```mermaid
graph TD
    A[Landowner Referral Closes JV] --> B{Select Incentive Track}
    B -->|Option 1| C[2% JV Split Booster - $28,380 Cash Value]
    B -->|Option 2| D[Heavy Civil Upgrades - $0 Cost to Owner]
    B -->|Option 3| E[CUVA Stewardship Endowment - $15,000 Grant]
    
    D --> D1[Upgrade A: Private Trout Spawning Stream - $18,500 Value]
    D --> D2[Upgrade B: Heavy-Duty Timber Bridge Crossing - $22,000 Value]
    D --> D3[Upgrade C: Creekside Cedar Fishing Pavilion - $15,000 Value]
```
