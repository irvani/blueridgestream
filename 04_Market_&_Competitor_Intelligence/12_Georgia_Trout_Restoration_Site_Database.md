...
## 🗺️ High-Priority Watershed Reaches & Sourcing Map

```
                     NORTH GEORGIA TROUT WATER BASINS
                     
        [ WEST: COOSA SYSTEM ]                 [ EAST: CHATTAHOOCHEE SYSTEM ]
  * Toccoa River (Fannin County)         * Soque River (Habersham County)
  * Noontootla Creek (Fannin County)     * Nacoochee Valley / Chattahoochee (White Co)
  * Cartecay River (Gilmer County)       * Upper Chestatee River (Lumpkin County)
  * Ellijay River (Gilmer County)        * Tallulah River Tributaries (Rabun County)
  * Fightingtown Creek (Fannin County)   * Cooper Creek Basin (Union County)
```
...
*   **Fluvial Degradation Profile**:
    *   *Agricultural Widening*: Historic cattle grazing and pasture clearing removed native deep-rooted riparian vegetation, allowing the river to widen from a stable $18\text{-foot}$ channel to a shallow, slow $35\text{-to-}45\text{-foot}$ sheet.
    *   *Solar Warming*: Unshaded pasture sections easily exceed $68^\circ\text{F}$ in mid-summer, threatening trout survival.
*   **Mitigation & Restoration Opportunity**:
...
## 5. Ellijay River Watershed (Gilmer County)
*   **Basin/HUC**: Coosa River Basin (HUC `03150102`)
...
## 6. Fightingtown Creek (Fannin County)
*   **Basin/HUC**: Coosa River Basin (HUC `03150102`)
...
## 7. Nacoochee Valley / Upper Chattahoochee River (White County)
*   **Basin/HUC**: Upper Chattahoochee Basin (HUC `03130001`)
...
## 8. Cooper Creek Basin (Union County)
*   **Basin/HUC**: Coosa River Basin (HUC `03150102`)
...
## 9. Upper Chestatee River Watershed (Lumpkin County)
*   **Basin/HUC**: Upper Chattahoochee Basin (HUC `03130001`)
...
## 10. Tallulah River Tributaries (Rabun County)
