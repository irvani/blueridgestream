...
```mermaid
graph TD
    A[Dirt Access Road Runoff] --> B[Severe Siltation in Goldmine Hollow]
    B --> C[Sand/Clay Smothers Noontootla Spawning Beds]
    D[Steep Mountain Stormwater] --> E[Headcutting & Vertical Channel Erosion]
    E --> F[Loss of Structural Grade Control]
    G[Clearing near Cabin] --> H[Bank Vulnerability & Solar Warming]
```
