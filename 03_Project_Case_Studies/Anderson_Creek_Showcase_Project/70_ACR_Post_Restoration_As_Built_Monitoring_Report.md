...
```
  ...
  [ stabilized bank ]                                     [ stabilized bank ]
   double-net coir                                         double-net coir
  ...
  _______                                                       _______
         \__                                                 __/
            \__                                           __/
               \___  [ toe-wood layer ]                __/
                   \__________________________________/   ◄── Thalweg pool depth: 4.5 ft
                        Sorted Clean gravel spawning runs 
```
...
```
               RESTORED THERMAL & BIOCHEMICAL PROFILE (JULY)
               
  [ MATURE CANOPY SHADE ] ───> [ 64.2°F COOL SUMMER COLD ] ───> [ ZERO THERMAL STRESS ]
                                                                
                                                                      │
                                                                      ▼
  [ WATER COLUMN DO (8.6 mg/L) ] <── [ SATURATION ELEVATION ( Henry's ) ] <┘
```
...
*   **The Geomorphic Process**: Constricting the channel bankfull width from 24.2 ft to 12.5 ft concentrated hydraulic shear stress. High-velocity storm flows successfully scoured and transported fine silts downstream, leaving a beautifully sorted bed of clean, gravelly substrate (D₅₀ = 22mm) ideal for nest excavation.
