...
```mermaid
graph TD
    A[Historic Deforestation & Runoff] --> B[Severe Bank Erosion]
    A --> C[Channel Widening & Shallowing]
    B --> D[Siltation Smothers Spawning Gravel]
    C --> E[Increased Solar Absorption / Water Warmup]
    D --> F[Loss of Trout & Macroinvertebrates]
    E --> F
    C --> G[Loss of Pool-Riffle Complexity]
    G --> F
```
