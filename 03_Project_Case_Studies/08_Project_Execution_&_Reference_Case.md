...
```
                  ACR STEP-BY-STEP CONSTRUCTION FLOW
                  
  [ 1. FIELD SURVEY ] ────────────────> [ 2. MATERIAL SOURCING ]
    Fluvial measurements,                 Local hemlock logs, root wads,
    BEHI index, cross-sections            and 2-3 ton angular granite boulders
    
                                                   │
                                                   ▼
                                                   
  [ 4. PLANTING & BUFFER ] <─────────── [ 3. INSTREAM EXCAVATION ]
    Native live stakes,                   Zoned construction, pump-arounds,
    100-foot canopy planting              grades, structure placement
```
...
*   **Sequencing**:
    ...
    3.  **Place Instream Structures**:
        *   **Log J-Hooks**: Trench the log vane $15\text{ degrees}$ upstream into the bank. Place the root wad at the bank face, and lock the log tail into place using heavy anchor boulders.
...
1.  **Instream Hardwood Structures**:
    *   **Logs**: 24 native Oak and Hemlock logs ($14^{\prime\prime}$ diameter, $22^{\prime}$ length), placed as J-Hooks and Vanes.
...
| **Estimated Credit Yield** | **12,900 Credits** (Gross: $2.32M) | Private Consulting Showcase | **7,440 Credits** (Gross: $892k) |
