...
> [!NOTE]
> **Regulatory Permitting & Case Studies Library**  
> **Template Type**: Nationwide Permit 27 Pre-Construction Notification (PCN)  
> **Federal Authority**: Clean Water Act Section 404 / USACE Savannah District  
...
## 2. USACE Form ENG 4345 Technical Narrative Template

```text
================================================================================
U.S. ARMY CORPS OF ENGINEERS - NATIONWIDE PERMIT 27 ATTACHMENT
...
--------------------------------------------------------------------------------
The primary ecological objective of this project is to restore natural fluvial geomorphic stability, improve aquatic wild trout habitats, and establish a native riparian forest buffer along a severely degraded 1,500-linear foot reach of Anderson Creek. 
...
--------------------------------------------------------------------------------
2. DETAILED DESCRIPTION OF PROPOSED ECOLOGICAL RESTORATION
--------------------------------------------------------------------------------
To achieve permanent geomorphic and biological lift, the Developer will implement Natural Channel Design (NCD) and geomorphic regrading:

A. BANK REGRASTING AND FLOODPLAIN RE-MEANDERING:
The existing steep, eroding banks (slopes up to 1:0.5) will be regraded to a stable 1:2 or 1:3 slope. A bankfull floodplain bench (15 feet wide) will be excavated to allow peak floodways to expand safely onto the valley flats, reducing bank shear stresses.
...
We will plant a minimum 100-foot wide native riparian forest buffer on both stream banks. The buffer will feature a high density of mature Rhododendron maximum transplants, tag alders, eastern hemlocks, and river birches (target density >= 320 stems/acre).
...
HEC-RAS floodway modeling has been completed for the 100-year peak-flow storm event. The water surface profiles demonstrate a complete 'No-Rise' (Delta WSEL <= 0.00 feet) across all cross-sections.
================================================================================
```
