...
```mermaid
graph TD
    Core[Core Leadership 3 FTEs] --> UGA[UGA Warnell Warnell Interns]
    Core --> GT[Georgia Tech CE Interns]
    Core --> Clemson[Clemson MRED Interns]
    UGA --> |Biological Surveys| Bio[EPA RBP III, Benthic EPT, HOBO Loggers]
    GT --> |Hydraulic Modeling| RAS[HEC-RAS 2D, AutoCAD NCD Sheets]
    Clemson --> |Sourcing & Finance| RIBITS[RIBITS Audit, Bankers CRM, Land JV splits]
```
